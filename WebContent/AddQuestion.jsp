    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
       ...
       <div class="container">
             <div class="row">
	             <div class="col-md-12">
		             <h1 class="text-center">Add Question Portal</h1>
	                     </div>
             </div>
       </div>
                   ...
                   <form method="post" action="SubmitQuestion">
                        <div class="form-row">
                            ...
                            catch(Exception e)
                            {
                             ...
                             <div class="form-group">
                              <div class="col-12">
                                <label for="test" class="font-weight-bolder" >Test Name</label>
                                <input type="text" class="form-control" id="test" name="testname" placeholder="Enter Test Name" required>
                             </div>
                             </div>
                          ...
                          <div class="form-row">
                            <div class="col-12">
                              <label for="que" class="font-weight-bolder" >Enter Question</label>
                              <textarea name="question" class="form-control" id="que" rows="6" cols="150" placeholder="Enter the Questions" required></textarea>
                            </div>
                          </div>
                           ...
                           <div class="form-row p-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="option4" id="op4" placeholder="OPTION-4" required>
                                </div>
                                </div>
