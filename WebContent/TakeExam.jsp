...
<jsp:useBean id="pDAO" class="com.main.FetchQuestion" scope="page"/>
<%
...
<body onload="startTime()">
                 ...
                 <div class="container">
                       ...
                       <div class="row">
                       <div class="col-md-12">
                       <h1 class="jumbotron p-2 text-center text-info">Exam Portal :&nbsp&nbsp<span class="text-warning"><%=request.getParameter("testname") %> </span>Exam &nbsp <i class="text-primary">Time :</i> <i id="clock" class="text-danger"></i></h1>
                       </div>
                       </div>
                       <div class="row">
                       ...
                       <%
                       ArrayList list=pDAO.getQuestions((String)session.getAttribute("email"),(String)session.getAttribute("standard"),request.getParameter("subjectname"),request.getParameter("testname"));
                       Questions question;
                       %>
              ...
              <input type="hidden" name="testName" value="<%=request.getParameter("testname")%> " >
		...
		try
	      {
	          ...
	          pstmt.setString(4, request.getParameter("subjectname"));
	          pstmt.setString(5, request.getParameter("testname"));
	          pstmt.setInt(6,1);
	          pstmt.setInt(7, 0);
	          pstmt.setInt(8,totalQuestions);  
	          pstmt.setString(9,dateandtime);
	          pstmt.setString(10,dateandtime);
	          pstmt.executeUpdate();
	          con.close(); 
	      }
